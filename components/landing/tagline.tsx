...
function Tagline({
  ...
  return (
    <Comp className={cn("w-auto cursor-pointer overflow-hidden rounded-full bg-background p-1 px-6 text-center font-semibold border border-brand", taglineVariants({ variant, className }))} {...props}>
      {children}
    </Comp>
  );
}
